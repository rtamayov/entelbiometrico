...
/*            if(bundle.getString("ScanRequest") != null && !bundle.getString("ScanRequest").isEmpty()){
            ...
            if(bundle.getString("file") != null && !bundle.getString("file").isEmpty()){
                scan_request_code = bundle.getString("file");
                scan_request_code = scan_request_code.substring(2, scan_request_code.length()-2);
            }
            ...
            new AlertDialog.Builder(this)
                    ...
                    .setPositiveButton("Ok", new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            ActivityCompat.requestPermissions(Main2.this, new String[] {Manifest.permission.WRITE_EXTERNAL_STORAGE},STORAGE_PERMISSION_CODE);
                        }
                    })
    ...
    private void guardarWSQ(ZyResponse response){
        ...
        try{
            ...
            File file = new File( Environment.getExternalStorageDirectory() +"/Android/data/com.outsystemscloud.roberttamayo.AbrirNativa/files/entelWSQ/", tvReceivedMsg.getText() + OUTPUT_FILE_EXTENSION);
    ...
    private void initializeEikon(){
        if(EIKON_STEP == 0){
            Intent intent = new Intent(Main2.this, EikonActivity.class);
